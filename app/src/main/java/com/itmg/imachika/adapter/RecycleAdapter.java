...
//    private static final String TAG = PersonAdapter.class.getSimpleName();
    private List<ReReview> list;
//
//    public RecycleAdapter(List<Person> list) {
//        this.list = list;
//    }
...
//        Logger.d(TAG, "onCreateViewHolder, i: " + i);
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_detail_review, null);
