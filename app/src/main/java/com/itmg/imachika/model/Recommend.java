...
public class Recommend implements Serializable {
    ...
    public List<Shop.Data.Info> getAdapterData() {
        return adapterData;
    }

    public void setAdapterData(List<Shop.Data.Info> adapterData) {
    ...
    private List<Shop.Data.Info> adapterData;
    private List<Shop.Data.Info> event;
    private List<Shop.Data.Info> holiday_attraction;
    private List<Shop.Data.Info> restaurant;
    private List<Shop.Data.Info> cafe;
    private List<Shop.Data.Info> shopping;

    public List<Shop.Data.Info> getHoliday_attraction() {
        return holiday_attraction;
    }

    public void setHoliday_attraction(List<Shop.Data.Info> holiday_attraction) {
        this.holiday_attraction = holiday_attraction;
    }

    public List<Shop.Data.Info> getRestaurant() {
        return restaurant;
    }

    public void setRestaurant(List<Shop.Data.Info> restaurant) {
        this.restaurant = restaurant;
    }

    public List<Shop.Data.Info> getCafe() {
        return cafe;
    }

    public void setCafe(List<Shop.Data.Info> cafe) {
        this.cafe = cafe;
    }

    public List<Shop.Data.Info> getShopping() {
        return shopping;
    }

    public void setShopping(List<Shop.Data.Info> shopping) {
        this.shopping = shopping;
    }

    public List<Shop.Data.Info> getEvent() {
        return event;
    }

    public void setEvent(List<Shop.Data.Info> event) {
        this.event = event;
    }
