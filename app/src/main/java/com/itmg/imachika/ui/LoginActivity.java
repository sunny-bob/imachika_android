...
public class LoginActivity extends FragmentActivity implements OkHttpUtil.Result , GoogleApiClient.OnConnectionFailedListener , GoogleLogin.GoogleSignListener {
...
//                        getUserFacebookBasicInfo();//获取facebook登录用户的基本信息的方法
    ...
    private void upLoadUserInfo(int type){
        ...
        params.put("location", PreferencesUtils.getString(LoginActivity.this,"location",""));
        ...
        OkHttpUtils.getInstance().okHttpPost(url, params, new RequestCallBack() {
            ...
            public void onSuccess(String result) {
                ...
                if(null != result){
                    ...
                    if (user.getStatus().equals("ok")) {
                        ...
                        PreferencesUtils.putString(LoginActivity.this, "userInfo", userInfo);
                        PreferencesUtils.putString(LoginActivity.this, "id", user.getUser().get_id());
            ...
            public void onFail() {
                mWaitDialog.dismiss();
                Toast.makeText(LoginActivity.this,getResources().getString(R.string.net_bad_retry), Toast.LENGTH_LONG).show();
            }
    ...
    @OnClick({R.id.img_back, R.id.tv_facebook, R.id.tv_google, R.id.tv_line, R.id.tv1,
            R.id.tv2, R.id.login_btn,R.id.login_register_view})
    ...
    private void login() {
        ...
        OkHttpUtil.post(URLInfo.login, Contans.login,body,this,this);
    }
            ...
            public void run() {
                switch (code){
                    ...
                    case Contans.login:
                        ...
                        if (user.getStatus().equals("ok")){
                            String userInfo = GsonUtil.objectToJson(user.getUser());
                            PreferencesUtils.putBoolean(LoginActivity.this, Constant.SP_IS_LOGIN,true);
                            PreferencesUtils.putString(LoginActivity.this,Constant.SP_USER_INFO,userInfo);
                            PreferencesUtils.putString(LoginActivity.this,Constant.SP_USER_NAME,user.getUser().getUser_name());
                            PreferencesUtils.putString(LoginActivity.this,Constant.SP_USER_ID,user.getUser().get_id());
//                            intent.setClass(getApplicationContext(), MainActivity.class);
//                            startActivity(intent);
                            finish();
                        }else{
